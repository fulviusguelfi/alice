...
// BaritoneToast removed (client-only)
// Client imports removed for server-side port
...
public final class Settings {
    ...
    public final Setting<Consumer<Component>> logger = new Setting<>((msg) -> {
        Helper.LOGGER.info("[Baritone] {}", msg.getString());
    });
     ...
     */
    @JavaOnly
    public final Setting<BiConsumer<Component, Component>> toaster = new Setting<>((title, message) -> {
        Helper.LOGGER.info("[Toast] {} {}", title.getString(), message.getString());
    });
