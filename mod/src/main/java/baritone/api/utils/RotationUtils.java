...
public final class RotationUtils {
    ...
    @Deprecated
    public static Optional<Rotation> reachable(Player entity, BlockPos pos, double blockReachDistance) {
        return reachable(entity, pos, blockReachDistance, false);
    }

    @Deprecated
    public static Optional<Rotation> reachable(Player entity, BlockPos pos, double blockReachDistance, boolean wouldSneak) {
